...
print(f'u8Type.name: {u8Type.name}')
print(f'u8Type.ref: {u8Type.ref}')
print(f'u16Type.name: {u16Type.name}')
print(f'u16Type.ref: {u16Type.ref}')
print(f'u32Type.name: {u32Type.name}')
print(f'u32Type.ref: {u32Type.ref}')
